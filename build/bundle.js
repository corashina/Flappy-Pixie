...
=======
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _textures__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textures */ \"./src/textures.js\");\n\nvar renderer,\n    scene,\n    camera,\n    mouseX = 0,\n    mouseY = 0;\nvar windowHalfX = window.innerWidth / 2;\nvar windowHalfY = window.innerHeight / 2;\ninit();\nanimate();\n\nfunction init() {\n  // Scene\n  scene = new THREE.Scene(); // scene.background = new THREE.Color(0xff0000)\n  // Renderer\n\n  renderer = new THREE.WebGLRenderer({\n    antialias: true,\n    canvas: document.querySelector('canvas')\n  });\n  renderer.setPixelRatio(window.devicePixelRatio);\n  renderer.setSize(window.innerWidth, window.innerHeight); // Light\n\n  scene.add(new THREE.AmbientLight(0xffffff)); // Camera\n\n  camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 1, 10000);\n  camera.position.set(0, 0, 1500);\n  var group = new THREE.Group();\n  var geometry = new THREE.PlaneGeometry(window.innerWidth, window.innerHeight, 32); // textures['05_far_BG'].anisotropy = renderer.getMaxAnisotropy();\n\n  var material = new THREE.MeshBasicMaterial({\n    map: _textures__WEBPACK_IMPORTED_MODULE_0__[\"default\"]['05_far_BG']\n  });\n  var plane = new THREE.Mesh(geometry, material);\n  group.add(plane);\n  var geometry = new THREE.PlaneGeometry(550, 55, 32);\n  var material = new THREE.MeshBasicMaterial({\n    transparent: true,\n    map: _textures__WEBPACK_IMPORTED_MODULE_0__[\"default\"]['00_roof_leaves']\n  });\n  var plane = new THREE.Mesh(geometry, material);\n  plane.translateZ(100);\n  plane.translateY(window.innerHeight / 2 - 75);\n  group.add(plane);\n  var geometry = new THREE.PlaneGeometry(530, 88, 32);\n  var material = new THREE.MeshBasicMaterial({\n    transparent: true,\n    map: _textures__WEBPACK_IMPORTED_MODULE_0__[\"default\"]['02_front_canopy']\n  });\n  var plane = new THREE.Mesh(geometry, material);\n  plane.translateZ(50);\n  plane.translateY(window.innerHeight / 2 - 125);\n  group.add(plane);\n  var geometry = new THREE.PlaneGeometry(window.innerWidth, 400, 32);\n  var material = new THREE.MeshBasicMaterial({\n    transparent: true,\n    map: _textures__WEBPACK_IMPORTED_MODULE_0__[\"default\"]['03_rear_canopy']\n  });\n  var plane = new THREE.Mesh(geometry, material);\n  plane.translateZ(25);\n  plane.translateY(window.innerHeight / 2 - 200);\n  group.add(plane);\n  var geometry = new THREE.PlaneGeometry(window.innerWidth, 400, 32);\n  var material = new THREE.MeshBasicMaterial({\n    transparent: true,\n    map: _textures__WEBPACK_IMPORTED_MODULE_0__[\"default\"]['03_rear_silhouette']\n  });\n  var plane = new THREE.Mesh(geometry, material);\n  plane.translateZ(25);\n  plane.translateY(-window.innerHeight / 2 + 200);\n  group.add(plane);\n  scene.add(group); // var geometry = new THREE.PlaneGeometry(2, 2, 32);\n  // var material = new THREE.MeshBasicMaterial({ map: textureLoader.load(\"./assets/flyingPixie.png\"), transparent: true });\n  // var plane = new THREE.Mesh(geometry, material);\n  // scene.add(plane);\n}\n\nfunction animate() {\n  requestAnimationFrame(animate);\n  render();\n}\n\nfunction render() {\n  camera.position.x += (mouseX - camera.position.x) * .01;\n  camera.position.y += (-mouseY - camera.position.y) * .01;\n  camera.lookAt(scene.position);\n  renderer.render(scene, camera);\n}\n\nwindow.addEventListener('resize', onWindowResize, false); // window.addEventListener('mousemove', onDocumentMouseMove, false);\n\nfunction onWindowResize() {\n  camera.aspect = window.innerWidth / window.innerHeight;\n  camera.updateProjectionMatrix();\n  renderer.setSize(window.innerWidth, window.innerHeight);\n}\n\nfunction onDocumentMouseMove(event) {\n  mouseX = (event.clientX - windowHalfX) / 10;\n  mouseY = (event.clientY - windowHalfY) / 10;\n}\n\n//# sourceURL=webpack:///./src/app.js?");
>>>>>>> 28cdee8750daea129dfe229402f7e9166c3d4476
...
=======
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_WorldAssets_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/WorldAssets.js */ \"./assets/WorldAssets.js\");\n\nconsole.log(_assets_WorldAssets_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nvar textureLoader = new THREE.TextureLoader();\nvar textures = {};\n\n__webpack_require__(\"./assets sync recursive \\\\.(jpg|png)$/\").keys().forEach(function (file) {\n  return textures[file.substring(2).replace(/\\.[^/.]+$/, \"\")] = textureLoader.load(\"./assets/\".concat(file.substring(2)), function (texture) {\n    return textures[file.substring(2).replace(/\\.[^/.]+$/, \"\")]['height'] = texture.image.height;\n  });\n});\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (textures);\n\n//# sourceURL=webpack:///./src/textures.js?");
>>>>>>> 28cdee8750daea129dfe229402f7e9166c3d4476
